# -*- encoding: utf-8 -*-
# stub: google-protobuf 4.33.3 x86_64-linux-gnu lib

Gem::Specification.new do |s|
  s.name = "google-protobuf".freeze
  s.version = "4.33.3".freeze
  ...
  s.metadata = { "source_code_uri" => "https://github.com/protocolbuffers/protobuf/tree/v4.33.3/ruby" } if s.respond_to? :metadata=
