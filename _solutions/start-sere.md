---
layout: default
title: "Ti Machann Micro-Savings"
permalink: /solutions/start-sere/
solution_id: "START-SERE"
---
...
<div class="max-w-4xl mx-auto py-20 px-6">
  ...
  <div class="bg-white p-10 rounded-[2.5rem] shadow-xl border border-slate-100 mb-10">
    ...
    <div class="space-y-4">
      <div class='p-4 bg-slate-50 rounded-xl border-l-4 border-emerald-500 font-medium text-slate-700'>Encourages daily financial discipline. Vendors can "deposit" small amounts of their daily earnings i...</div>
    </div>
  </div>

  <a href="https://wa.me/{{ site.whatsapp_number }}?text=ID:START-SERE" 
