---
layout: default
title: "Local Job Finder & Labour Board (Bous-Travay)"
permalink: /solutions/start-oj-b/
solution_id: "START-OJ-B"
---
...
<div class="max-w-4xl mx-auto py-20 px-6">
  ...
  <div class="bg-white p-10 rounded-[2.5rem] shadow-xl border border-slate-100 mb-10">
    ...
    <div class="space-y-4">
      <div class='p-4 bg-slate-50 rounded-xl border-l-4 border-emerald-500 font-medium text-slate-700'>Using the **Verified Hub**, this flow acts as a digital bulletin board. Homeowners post "Need a wall...</div>
    </div>
  </div>

  <a href="https://wa.me/{{ site.whatsapp_number }}?text=ID:START-OJ-B" 
