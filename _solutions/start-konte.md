---
layout: default
title: "Literacy Voice Story"
permalink: /solutions/start-konte/
solution_id: "START-KONTE"
---
...
<div class="max-w-4xl mx-auto py-20 px-6">
  ...
  <div class="bg-white p-10 rounded-[2.5rem] shadow-xl border border-slate-100 mb-10">
    ...
    <div class="space-y-4">
      <div class='p-4 bg-slate-50 rounded-xl border-l-4 border-emerald-500 font-medium text-slate-700'>The bot sends a short Kreyòl audio story. At the end, it asks: "What color was the cow's hat?" Users...</div>
    </div>
  </div>

  <a href="https://wa.me/{{ site.whatsapp_number }}?text=ID:START-KONTE" 
